    ...
    if (!isSignInForm) {
      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            displayName: name.current.value, photoURL: "https://avatars.githubusercontent.com/u/69577773?v=4"
          }).then(() => {
  ...
  return (
    <div>
      ...
      >
        ...
        <button
          className="p-2 my-4 bg-red-600 w-full rounded-sm cursor-pointer"
